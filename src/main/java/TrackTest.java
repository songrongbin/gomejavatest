...
/**
 * Created by songrongbin on 2017/8/18.
 */
public class TrackTest {
    private static final String productDomain = "http://api.ximalaya.com/openapi-gateway-app/tracks/";
    ...
    public static String caculateSignature(Map<String, String> paramsMap, String seed) throws InvalidKeyException,
    ...
    public static void main(String args[]) throws NoSuchAlgorithmException, InvalidKeyException, IOException {
        ...
        String url = productDomain + "get_batch";
